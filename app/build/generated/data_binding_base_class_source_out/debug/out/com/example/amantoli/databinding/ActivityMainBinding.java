...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull EditText emailInput,
      @NonNull Button loginButton, @NonNull TextView loginTitle, @NonNull ConstraintLayout main,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, emailInput, loginButton,
          loginTitle, main, passwordInput, registerButton);
    }
