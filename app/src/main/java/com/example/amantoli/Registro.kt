...
class Registro : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nameInput = findViewById(R.id.nombre)
        aPatInput = findViewById(R.id.aPaterno)
        aMatInput = findViewById(R.id.aMaterno)
        ageInput = findViewById(R.id.edad)
        radioGenero = findViewById(R.id.radioGenero)
        birthdateInput = findViewById(R.id.fechaNac)
        emailInput = findViewById(R.id.correo)
